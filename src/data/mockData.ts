...
export const INITIAL_OPERATORS: Operator[] = [
  // Usinagem
  {
    ...
    phone: '(11) 98765-4321',
    notes: 'Operador Sênior CNC. Responsável por ajustes finos.',
  ...
  },
  {
    ...
    phone: '(11) 98765-4322',
    notes: 'Turno Manhã - Fresa e Tornos automáticos.',
  ...
  },
  {
    ...
    phone: '(11) 98765-4323',
    notes: 'Especialista em usinagem de eixos e flanges.',
  ...
  },
  {
    ...
    phone: '(11) 98765-4324',
    notes: 'Operador de Fresa universal e ferramentas de corte.',
  ...
  },
  {
    ...
    machine: 'TORNO 01',
    badge: 'USIN-035',
    email: 'marcio.oliveira@empresa.com.br',
    phone: '(11) 98765-4325',
    notes: 'Preparador de Tornos Nardini.',
  ...
  },
  {
    ...
    machine: 'CNC 30',
    badge: 'USIN-038',
    email: 'gabriel.costa@empresa.com.br',
    phone: '(11) 98765-4326',
    notes: 'Operador de centro de usinagem 3 eixos.',
  ...
  },
  {
    ...
    phone: '(11) 98765-4327',
    notes: 'Operador de torno convencional.',
  ...
  },
  {
    ...
    phone: '(11) 98765-4328',
    notes: 'Retiradas de micrômetros e paquímetros diários.',
  ...
  },
  {
    ...
    phone: '(11) 98765-4329',
    notes: 'Operador de Centro de Usinagem.',
  ...
  // Produção
  {
    ...
    phone: '(11) 98765-4330',
    notes: 'Supervisão do chão de fábrica.',
    avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-11b',
    ...
    phone: '(11) 98765-4331',
    notes: 'Líder de linha de montagem.',
    avatarUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-11c',
    ...
    machine: 'PRODUÇÃO',
    badge: 'PROD-008',
    email: 'pablo.ferreira@empresa.com.br',
    phone: '(11) 98765-4332',
    notes: 'Operador de prensas e dobradeiras.',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-12',
  ...
  // Manutenção
  {
    ...
    machine: 'MANUTENÇÃO',
    badge: 'MANT-001',
    email: 'nilson.souza@empresa.com.br',
    phone: '(11) 98765-4334',
    notes: 'Técnico de Manutenção Preventiva e Corretiva.',
    avatarUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-13b',
    ...
    machine: 'MANUTENÇÃO',
    badge: 'MANT-003',
    email: 'marcos.azevedo@empresa.com.br',
    phone: '(11) 98765-4335',
    notes: 'Eletromecânico de manutenção.',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-13c',
    ...
    machine: 'MANUTENÇÃO',
    badge: 'MANT-005',
    email: 'renato.mendes@empresa.com.br',
    phone: '(11) 98765-4336',
    notes: 'Auxiliar de manutenção mecânica.',
    avatarUrl: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&q=80&w=150'
  },
  ...
  // Estoque
  {
    ...
    machine: 'ESTOQUE',
    badge: 'EST-001',
    email: 'elias.nogueira@empresa.com.br',
    phone: '(11) 98765-4337',
    notes: 'Almoxarife sênior.',
    avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-15b',
    ...
    machine: 'ESTOQUE',
    badge: 'EST-002',
    email: 'lucas.monteiro@empresa.com.br',
    phone: '(11) 98765-4338',
    notes: 'Conferente de ferramentas.',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-15c',
    ...
    machine: 'ESTOQUE',
    badge: 'EST-003',
    email: 'rafael.dias@empresa.com.br',
    phone: '(11) 98765-4339',
    notes: 'Organizador do almoxarifado.',
    avatarUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-15',
    ...
    phone: '(11) 98765-4340',
    notes: 'Gestor da Ferramentaria Central.',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=150'
  },
  ...
  // Expedição
  {
    ...
    machine: 'EXPEDIÇÃO',
    badge: 'EXP-001',
    email: 'deise.ramos@empresa.com.br',
    phone: '(11) 98765-4341',
    notes: 'Líder de expedição.',
  ...
  },
  {
    ...
    machine: 'EXPEDIÇÃO',
    badge: 'EXP-002',
    email: 'frank.martins@empresa.com.br',
    phone: '(11) 98765-4342',
    notes: 'Embalagem e pesagem.',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-16c',
    ...
    machine: 'EXPEDIÇÃO',
    badge: 'EXP-003',
    email: 'giulia.barreto@empresa.com.br',
    phone: '(11) 98765-4343',
    notes: 'Faturamento de saída.',
    avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-16d',
    ...
    machine: 'EXPEDIÇÃO',
    badge: 'EXP-004',
    email: 'adriano.siqueira@empresa.com.br',
    phone: '(11) 98765-4344',
    notes: 'Operador de empilhadeira.',
    avatarUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-16e',
    ...
    machine: 'EXPEDIÇÃO',
    badge: 'EXP-005',
    email: 'ismael.teixeira@empresa.com.br',
    phone: '(11) 98765-4345',
    notes: 'Conferência técnica.',
    avatarUrl: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-16f',
    ...
    phone: '(11) 98765-4346',
    notes: 'Controle de paletes e carregamento.',
    avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=150'
  },
  ...
  // PCP
  {
    ...
    machine: 'PCP',
    badge: 'PCP-001',
    email: 'jose.almeida@empresa.com.br',
    phone: '(11) 98765-4347',
    notes: 'Programador de produção.',
    avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-14b',
    ...
    phone: '(11) 98765-4348',
    notes: 'Planejamento e Controle de Produção.',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-14c',
    ...
    phone: '(11) 98765-4349',
    notes: 'Analista de rotas de produção.',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-14d',
    ...
    machine: 'PCP',
    badge: 'PCP-004',
    email: 'ygor.carvalho@empresa.com.br',
    phone: '(11) 98765-4350',
    notes: 'Assistente de PCP.',
    avatarUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-14e',
    ...
    machine: 'PCP',
    badge: 'PCP-005',
    email: 'janaina.pcp@empresa.com.br',
    phone: '(11) 98765-4354',
    notes: 'Analista de PCP e programação de ordens de serviço.',
    avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=150'
  },
  ...
  // Qualidade
  {
    ...
    phone: '(11) 98765-4351',
    notes: 'Auditor de qualidade e aferição de porcas calibradoras.',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-8',
    ...
    machine: 'QUALIDADE',
    badge: 'QUAL-001',
    email: 'alexandre.qualidade@empresa.com.br',
    phone: '(11) 98765-4352',
    notes: 'Inspetor Chefe de Qualidade e Calibração ISO 9001.',
    avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=150'
  },
  {
    id: 'op-10',
    ...
    machine: 'QUALIDADE',
    badge: 'QUAL-003',
    email: 'lilian.santos@empresa.com.br',
    phone: '(11) 98765-4353',
    notes: 'Metrologia técnica e laboratório.',
    avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=150'
  }
];
